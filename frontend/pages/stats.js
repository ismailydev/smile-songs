    ...
    return (
        <main className="py-4 pb-12">
            {songs ? (
                <>
                    ...
                    {songs && (
                        <div className="flex justify-center gap-32">
                            <div className="py-8">
                                <h3 className="pb-8 text-xl">General Stats</h3>
                            ...
                            <div className="py-8">
                                <h3 className="pb-8 text-xl">Specific Stats</h3>
                                <div className="pb-8">
                                    <div className="flex">
                ...
                <div className="w-full min-h-[85vh] bg-black/10 flex items-center justify-center">
                    <Spinner />
                </div>
            )}
        </main>
